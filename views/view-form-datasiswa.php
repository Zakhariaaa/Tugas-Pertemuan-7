        ...
        <form action="<?= base_url('datasiswa/cetak'); ?>" method="post"> 
            <table> 
                ...
                <tr align="left"> 
                    ...
                    <th>:</th> 
                    <td>
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir"placeholder="Input Tanggal Lahir" size="29"> 
                ...
                <tr align="left"> 
                    ...
                    <th>:</th> 
                    <td>
                        <textarea type="text" name="alamat" id="alamat" placeholder="Input Alamat" rows="5" cols="30"></textarea> 
